// Mechanical v1 → PSML 0.2 migration tool.
//
// Reads the runtime `PRESETS` registry from lib/psml/runtime-presets.ts and
// writes lib/psml/presets.generated.ts with best-effort PSML equivalents.
// `color` is intentionally dropped — PSML carries semantic category only;
// the renderer maps category → CSS variable in `web/lib/render-tokens.ts`.
//
...
const outPath = resolve(root, "lib/psml/presets.generated.ts");
...
function main(): void {
  ...
  const banner = `// PSML 0.2 — Packet Schema Markup Language.
// AUTO-GENERATED by scripts/migrate-v1-to-psml.ts.
