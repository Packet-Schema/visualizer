...
// Type definitions for the PSDL wire format: a unified recursive packet
...
/** The set of varint encodings PSDL 0.3 supports. */
 ...
 *
 * PSDL 0.4 primitive — paired with `Optional` and `peek`. See issue #67.
 */
 ...
 * back to 0 when absent. PSDL 0.4 primitive — see issue #67.
 */
...
export type Field = {
   ...
   * in this order regardless of the enclosing Packet's byteOrder. PSDL 0.4
 ...
 * truthy in the current env. PSDL 0.4 primitive — see issue #67.
 */
...
export type Constraint = {
   ...
   * insert / delete. Not part of the on-wire PSDL contract; emitters
...
export type NormalizedField = {
  ...
  /** Per-field byte order override (PSDL 0.4) — propagated from Field.byteOrder. */
  byteOrder?: "BE" | "LE";
  /**
   ...
   * is the only PSDL primitive whose semantic the renderer treats as
