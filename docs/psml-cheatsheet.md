...
PSML (Packet Schema Markup Language) の **1 ページ要約**。
詳しくは [`psml-0.4.md`](./psml-0.4.md) の該当節へ。
...
詳細: [`psml-0.4.md` §Types](./psml-0.4.md#types) /
[Varint](./psml-0.4.md#varint-03) / [BER/DER](./psml-0.4.md#berder-length-04)
...
詳細: [`psml-0.4.md` §Expressions](./psml-0.4.md#expressions) /
[Peek](./psml-0.4.md#peek-expression-04)
...
詳細: [`psml-0.4.md` §Containers](./psml-0.4.md#containers) /
[Optional](./psml-0.4.md#optional-04) /
[Encrypted](./psml-0.4.md#encrypted-03)
...
詳細: [`psml-0.4.md` §Constraints](./psml-0.4.md#constraints)
...
詳細: [`psml-0.4.md` §Packet](./psml-0.4.md#packet) /
[JSON serialization](./psml-0.4.md#json-serialization)

---

## すぐ書き始めたい人向けテンプレ

`data/presets/<key>.psml.yaml` にコピペしてからフィールドを書き換えてください。
